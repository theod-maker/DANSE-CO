    ...
    >
      ...
      <div className="p-5 md:p-8 flex flex-col gap-6 relative">
        ...
        <div className="relative z-10">
          <h3 style={{ fontFamily: "'Instrument Serif', serif" }} className="text-[#18102E] text-2xl md:text-3xl tracking-tight mb-3">{title}</h3>
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-40 pb-32 relative">
        <div
          ...
          style={{ width: 500, height: 500, top: '-50px', right: '-150px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(107,33,168,0.05) 0%, transparent 70%)', filter: 'blur(60px)' }}
        />
