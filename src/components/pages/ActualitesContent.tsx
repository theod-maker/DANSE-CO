    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-40 pb-32 relative">
        ...
        <div ref={headerRef} className="mb-20 relative z-10">
          <motion.p initial={{ opacity: 0, y: 20 }} animate={headerInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-[#18102E]/40 text-xs tracking-widest uppercase font-ui mb-6">Actualités</motion.p>
